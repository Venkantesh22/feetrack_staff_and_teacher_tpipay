...
class StudentDetailsResponse {
  ...
  StudentDetailsResponse.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int? ?? 0,
        ...
        rollNumber = json['roll_number'] as int? ?? 0,
        admissionDate = json['admission_date'] as String? ?? '',
        schoolId = json['school_id'] as int? ?? 0,
        applicationStatus = json['application_status'] as int? ?? 0,
        ...
        subjects = StudentSubjects.fromJson(Map.from(json['subjects'] ?? {})),
...
class CoreSubject {
  ...
  CoreSubject.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int? ?? 0,
        ...
        mediumId = json['medium_id'] as int? ?? 0,
        type = json['type'] as String? ?? '',
        schoolId = json['school_id'] as int? ?? 0,
        deletedAt = json['deleted_at'] as String?,
        classSubjectId = json['class_subject_id'] as int? ?? 0,
        nameWithType = json['name_with_type'] as String? ?? '',
        pivot = Pivot.fromJson(Map.from(json['pivot'] ?? {})),
        subject = Subject.fromJson(Map.from(json));
...
class ClassSubject {
  ...
  ClassSubject.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int? ?? 0,
        ...
        type = json['type'] as String? ?? '',
        electiveSubjectGroupId = json['elective_subject_group_id'] as int? ?? 0,
        semesterId = json['semester_id'] as int?,
        virtualSemesterId = json['virtual_semester_id'] as int? ?? 0,
        schoolId = json['school_id'] as int? ?? 0,
        deletedAt = json['deleted_at'] as String?,
        createdAt = json['created_at'] as String? ?? '',
        updatedAt = json['updated_at'] as String? ?? '',
...
class StudentUser {
  ...
  StudentUser.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int? ?? 0,
        ...
        resetRequest = json['reset_request'] as int? ?? 0,
        schoolId = json['school_id'] as int? ?? 0,
        language = json['language'] as String? ?? '',
        emailVerifiedAt = json['email_verified_at'] as String?,
        twoFactorEnabled = json['two_factor_enabled'] as int? ?? 0,
...
class StudentClass {
  ...
  StudentClass.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int? ?? 0,
        name = json['name'] as String? ?? '',
        includeSemesters = json['include_semesters'] as int? ?? 0,
        mediumId = json['medium_id'] as int? ?? 0,
